...
app.get('/api/stats', (req, res) => {
    try {
        ...
        if (!fs_1.default.existsSync(jsonFilePath) || !fs_1.default.existsSync(protoFilePath)) {
    ...
    try {
        ...
        while (offset < protoReadData.length && currentIndex <= index) {
            ...
            if (currentIndex === index) {
                ...
                currentEvent = proto_service_1.default.decodeEvent(messageBuffer);
                break;
            }
