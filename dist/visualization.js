...
// Write the HTML file
const htmlFilePath = path_1.default.join(outputDir, 'comparison.html');
...
`;
const updateScriptPath = path_1.default.join(__dirname, '../update-visualization.js');
fs_1.default.writeFileSync(updateScriptPath, updateScript);
fs_1.default.chmodSync(updateScriptPath, '755'); // Make the script executable
